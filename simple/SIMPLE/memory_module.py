import torch
import dgl
from SIMPLE.layers import TimeEncode
import time
...
class MailBox():
    ...
    def update_memory_eval(self, nid, memory, root_nodes, ts, neg_samples=1):
        if nid is None:
            return
    ...
    def offload_for_eval(self, gpu_flag, gpu_map):
        ...
        self.mailbox[cpu_ids] = self.mailbox_buffs[gpu_ids].cpu()
