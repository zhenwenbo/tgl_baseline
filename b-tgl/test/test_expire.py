...
def gen_expire(d, batch_size = 600000):
    ...
    for cur_batch, rows in df[:train_edge_end].groupby(group_indexes):  
        ...
        ret_list = sampler_gpu.sample_layer(root_nodes, root_ts, expired=expired, sample_mode = 'expire')
...
max_edge_num = gen_expire(args.data)
data = {args.data: max_edge_num}

file_path = './expire.json'
