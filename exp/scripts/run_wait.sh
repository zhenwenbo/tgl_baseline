...
echo "执行后续逻辑"
bash /raid/guorui/workspace/dgnn/exp/scripts/pre.sh
bash /raid/guorui/workspace/dgnn/exp/scripts/run_test.sh
# bash /raid/guorui/workspace/dgnn/exp/scripts/run_b_tgl.sh