...
parser.add_argument('--txt', type=str, help='txt file path', default = "/raid/guorui/DG/dataset/STACK/sx-stackoverflow.txt")
...
print('save csv...')
df.to_csv('/raid/guorui/DG/dataset/{}/edges.csv'.format(args.data))

print('generate graph...')
#gen_graph
df = pd.read_csv('/raid/guorui/DG/dataset/{}/edges.csv'.format(args.data))
